...
void main() {
  ...
  test('native main menu exposes keyboard shortcuts action', () {
    ...
    expect(app, contains('menu: l10n.mainMenuTooltip'));
    expect(app, contains('settings: l10n.settingsMenuItem'));
    expect(app, contains('keyboardShortcuts: l10n.keyboardShortcutsMenuItem'));
    expect(app, contains('aboutBusyMark: l10n.aboutBusyMarkMenuItem'));
    ...
    expect(welcome, contains('tooltip: l10n.mainMenuTooltip'));
