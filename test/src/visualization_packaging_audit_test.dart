...
void main() {
  ...
  test('release metadata is consistent and production-grade', () {
    ...
    expect(pubspec, contains(RegExp(r'^version: 0\.4\.0$', multiLine: true)));
    expect(
      snapcraft,
      contains(RegExp(r'^version: "0\.4\.0"$', multiLine: true)),
    );
    ...
    expect(metainfo, contains('<release version="0.4.0"'));
    expect(pubspec, isNot(contains('0.4.00')));
    expect(snapcraft, isNot(contains('0.4.00')));
  });
