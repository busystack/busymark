...
void main() {
  test('release metadata is consistent and production-grade', () {
    ...
    expect(pubspec, contains(RegExp(r'^version: 0\.3\.2$', multiLine: true)));
    expect(
      snapcraft,
      contains(RegExp(r'^version: "0\.3\.2"$', multiLine: true)),
    );
    ...
    expect(metainfo, contains('<release version="0.3.2"'));
    expect(pubspec, isNot(contains('0.3.24')));
    expect(snapcraft, isNot(contains('0.3.24')));
  });
